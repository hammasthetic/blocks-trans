...
export const ConnectionOptions = ({
  ...
  function getOptions(isActive: boolean) {
    ...
    const metaMaskOption = hasMetaMaskExtension ? (
      ...
      <a href={METAMASK_URL}>
        <button className='hover:shadow-lg ease-linear transition-all duration-150 mx-2 text-white bg-green-500 px-2 py-3  rounded-full  hover:text-green-500 hover:bg-white'>Install Metamask</button>
      </a>
    )
